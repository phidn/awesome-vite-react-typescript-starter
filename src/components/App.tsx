      ...
      <div className='h-screen sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48'>
        <div className='relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8'>
          <div className='sm:max-w-lg'>
            <div className='my-4'>
              <Avatar size='large' src='https://www.gravatar.com/avatar/4405735f6f3129e0286d9d43e7b460d0' />
            </div>
            <h1 className='text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl'>Welcome!</h1>
            <p className='mt-4 text-xl text-gray-500'>
              This is a boilerplate build with Vite, React 18, TypeScript, Vitest, Testing Library, TailwindCSS 3,
              Eslint and Prettier.
            </p>
          </div>
          <div>
